...
export const ShareSheet: React.FC<ShareSheetProps> = ({ isOpen, onClose, postId }) => {
    ...
    const handleRepost = async () => {
        try {
            ...
            alert('Репост выполнен! Пост теперь в вашей ленте.');
            onClose();
        } catch (err) {
            console.error(err);
        }
    ...
    const copyLink = () => {
        ...
        alert('Ссылка на пульс скопирована!');
        onClose();
    };
        ...
        if (navigator.share) {
            try {
                await navigator.share({
                    title: 'Pulse App',
                    text: 'Посмотри этот крутой пульс!',
                ...
                <>
                    ...
                    >
                        <div className="share-section">
                            <div className="share-section-title">Быстрая отправка</div>
                            <div className="share-horizontal-scroll">
                                {(followingIds || []).map(fId => (
                                    <div key={fId} className="friend-item" onClick={() => alert(`Отправлено в личные сообщения`)}>
                                        <div className="friend-avatar">
                                            <User size={24} color="#555" />
                                        </div>
                                        <span className="friend-name">Друг</span>
                                    </div>
                                ))}
                        ...
                        <div className="repost-container">
                            <div className="repost-btn" onClick={handleRepost}>
                                ...
                                <span className="repost-label">Репостнуть</span>
                            </div>
                        </div>

                        <div className="share-section">
                            <div className="share-section-title">Поделиться в других приложениях</div>
                            <div className="share-horizontal-scroll">
                                ...
                                <div className="social-item" onClick={handleNativeShare}>
                                ...
                                <div className="social-item" onClick={handleNativeShare}>
                                    <div className="social-icon-circle whatsapp">
                                ...
                                <div className="social-item" onClick={handleNativeShare}>
                                    <div className="social-icon-circle other">
